# Condura — LOGBOOK archive (2026-06)

> **Archived session history** extracted from `condura-mind/LOGBOOK.md` on 2026-07-10.
> Append-only contract preserved: nothing was deleted; it was relocated.
> The live `LOGBOOK.md` retains recent entries + the How-to-Use template +
> July 2026+ entries. Agents should read the live file first; open this
> archive only when investigating pre-July-2026 decisions.
