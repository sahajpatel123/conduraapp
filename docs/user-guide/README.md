...
These will be written in **Phase 5 or later**, after the core features are implemented. We want the docs to reflect the actual product, not a hypothetical one.
