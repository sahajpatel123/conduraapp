...
export type OnboardingStep = 'welcome' | 'provider' | 'apikey' | 'test' | 'hotkey' | 'privacy' | 'done'
...
class OnboardingStore {
  ...
  nextStep(): void {
    const order: OnboardingStep[] = ['welcome', 'provider', 'apikey', 'test', 'hotkey', 'privacy', 'done']
